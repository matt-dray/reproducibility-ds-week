...
3. And even your workflow

???
* These are very broad -- what do they mean?
* Let's go through one by one
* I'll be focuing on R, but I think these points are transferable
...
* also try [{here}](https://here.r-lib.org/) for [relative file paths](https://github.com/jennybc/here_here)
* use [Git and maybe GitHub](https://speakerdeck.com/alicebartlett/git-for-humans) for version control 
